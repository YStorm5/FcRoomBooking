...
namespace FcRoomBooking.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                _roleManager.CreateAsync(new ApplicationRole(Role.Role_Admin)).GetAwaiter().GetResult();
                _roleManager.CreateAsync(new ApplicationRole(Role.Role_Manager)).GetAwaiter().GetResult();
                _roleManager.CreateAsync(new ApplicationRole(Role.Role_Employee)).GetAwaiter().GetResult();
            }
